<?php 
    ...
    if($_POST['register']){
        ...
        if($insert){
            echo '<script> window.location="http://localhost/samuel/addSuspect/added"; </script>';
        }else{
            echo "
...
<div class="row">
    <div class="col-md-12" style="background:#fff;padding:20px;">
        <form action="addSuspect" method="POST" enctype="multipart/form-data" class="insert">
            <div class="row mp">
                <div class="col-md-6 box1 mp">
                    <div class="row mp">
                        <div class="col-md-11 mp">
                            <label for="names">Names:</label>
                            <input type="text" name="n" id="names" placeholder="Enter Suspect Names" required>
                            <label for="h">Height:</label>
                            <input type="text" name="h" id="h" placeholder="Enter Suspect Height (Meters)" required>
                            <label for="c">Complexion:</label>
                            <input type="text" name="c" id="c" placeholder="Enter Suspect Complexion" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 box2 mp">
                    <div class="row mp">
                        <div class="col-md-11 mp">
                            ...
                            <input type="email" name="e" id="e" placeholder="Enter Suspect Email">
                            <label for="w">Weight:</label>
                            <input type="text" name="w" id="w" placeholder="Enter Suspect Weight (Kg)" required>
                            <label for="o">Occupation:</label>
                            <input type="text" name="o" placeholder="Enter Suspect Occupation" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 box mp">
                    <div class="row mp">
                        <div class="col-md-11 mp">
                            ...
                            <textarea name="a" id="a" placeholder="Enter Suspect Address" required></textarea>
                        </div>        
                    </div>
                </div>
                <div class="col-md-6 box1 mp">
                    <div class="row mp">
                        <div class="col-md-11 mp">
                            ...
                            <label for="cc">Crime Code:</label>
                            <input type="text" name="cc" id="cc" placeholder="Enter Crime Code" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 box2 mp">
                    <div class="row mp">
                        <div class="col-md-11 mp">
                            ...
                            <input type="text" name="oic" id="oic" placeholder="Enter Name Of Officer In Charge" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 box mp">
